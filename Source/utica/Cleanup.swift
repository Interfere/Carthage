...
/*
 Former file of `utica cleanup` command — which existed on-master, but unshipped-in-tags — and no longer makes sense when set of SDKs are non-fixed across Xcode versions.
