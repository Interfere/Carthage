...
public struct Resolver: ResolverProtocol {
	...
	public func resolve(
		...
		return graphs(for: dependencies, dependencyOf: nil, basedOnGraph: DependencyGraph())
			.take(first: 1)
			.observe(on: QueueScheduler(qos: .default, name: "org.utica.UticaKit.Resolver.resolve"))
	...
	private func nodePermutations(for dependencies: [Dependency: VersionSpecifier]) -> SignalProducer<[DependencyNode], CarthageError> {
		let scheduler = QueueScheduler(qos: .default, name: "org.utica.UticaKit.Resolver.nodePermutations")
	...
	private func graphsForDependenciesOfNode(_ node: DependencyNode, basedOnGraph inputGraph: DependencyGraph) -> SignalProducer<DependencyGraph, CarthageError> {
		let scheduler = QueueScheduler(qos: .default, name: "org.utica.UticaKit.Resolver.graphsForDependenciesOfNode")
	...
	private func graphs(
		...
		let scheduler = QueueScheduler(qos: .default, name: "org.utica.UticaKit.Resolver.graphs")
