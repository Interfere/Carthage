...
public struct Constants {
	...
	/// the intended ~/Library/Caches/org.utica.UticaKit cannot
	/// be found or created.
	private static let fallbackDependenciesURL: URL = {
		let homePath: String
		if let homeEnvValue = ProcessInfo.processInfo.environment["HOME"] {
			homePath = (homeEnvValue as NSString).appendingPathComponent(".utica")
		} else {
			homePath = ("~/.utica" as NSString).expandingTildeInPath
		}
		return URL(fileURLWithPath: homePath, isDirectory: true)
	}()

	/// ~/Library/Caches/org.utica.UticaKit/
	...
	public struct Dependency {
		...
		/// stored.
		///
		/// ~/Library/Caches/org.utica.UticaKit/binaries/
		...
		///
		/// ~/Library/Caches/org.utica.UticaKit/dependencies/
		...
		///
		/// ~/Library/Caches/org.utica.UticaKit/DerivedData/
